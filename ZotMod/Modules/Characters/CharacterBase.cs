...
namespace LordZot.Modules.Characters
{
    internal abstract class CharacterBase
    {
        ...
        public string fullBodyName => "ZotBody";
        ...
        {
            bodyPrefab = Modules.Prefabs.CreateBodyPrefab("LordZot_Body", "LordZot", bodyInfo);
            prefabCharacterBody = bodyPrefab.GetComponent<CharacterBody>();
            Debug.Log("Created" + bodyPrefab.name);
 ...
 /*       public virtual void InitializeItemDisplays()
    ...
    {
        #region Character
        public string bodyName = "LordZot_Body";
        public string bodyNameToken = "Lord Zot";
        public string subtitleNameToken = "Mystic Titan";
        ...
        #region Camera
        public Vector3 aimOriginPosition = new Vector3(0f, 1.8f, 0f);
        public Vector3 modelBasePosition = new Vector3(0f, 0f, 0f);

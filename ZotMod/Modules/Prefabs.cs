...
namespace LordZot.Modules {
    ...
    internal static class Prefabs
    {
        ...
        private static void SetupCameraTargetParams(GameObject prefab, BodyInfo bodyInfo)
        {
            ...
            cameraTargetParams.cameraParams.standardLocalCameraPos = new Vector3(0f, 0f, 0f);
        ...
        private static void SetupMainHurtbox(GameObject prefab, GameObject model)
        {
            ...
            HurtBox mainHurtbox = model.GetComponentInChildren<CapsuleCollider>().gameObject.AddComponent<RoR2.HurtBox>();
        ...
        private static void SetupFootstepController(GameObject model)
        {
            ...
            footstepHandler.baseFootstepString = "Play_golem_step";
            footstepHandler.sprintFootstepOverrideString = "";
            footstepHandler.enableFootstepDust = true;
            footstepHandler.footstepDustPrefab = LegacyResourcesAPI.Load<GameObject>("Prefabs/GenericHugeFootstepDust");
        }
        ...
        private static void SetupAimAnimator(GameObject prefab, GameObject model)
        {
            ...
            aimAnimator.pitchRangeMax = 140f;
            aimAnimator.pitchRangeMin = -140f;
            aimAnimator.yawRangeMin = -140f;
            aimAnimator.yawRangeMax = 140f;
            aimAnimator.pitchGiveupRange = 240f;
            aimAnimator.yawGiveupRange = 240f;
